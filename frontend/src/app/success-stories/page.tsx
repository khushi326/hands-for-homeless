...
export default function SuccessStories() {
  const stories = [
    {
      name: 'Ramesh Kumar',
      location: 'Tambaram, Tamil Nadu',
      story: 'Ramesh was spotted shivering in the cold winter rains near the railway station. A citizen reported his case on HFH. Within 20 minutes, a nearby volunteer arrived with hot food, blankets, and coordinated with a local shelter. Today, Ramesh has a night shelter placement and is enrolled in a vocational rehabilitation course.',
      volunteer: 'Arvind Swamy',
      date: 'July 2026',
    },
    {
      name: 'Maria & Daughter',
      location: 'Peerkankaranai, Chennai',
      story: 'Struggling after losing her job, Maria was forced to live on the streets with her 5-year-old child. A local store owner used HFH to request urgent shelter and food assistance. Volunteers secured immediate temporary housing within 3 hours. Community donations subsequently funded a deposit for a small rental apartment.',
      volunteer: 'Sindhuja M',
      date: 'June 2026',
    },
    {
      name: 'Joseph D\'Souza',
      location: 'Valayapathi St, Tambaram',
      story: 'Joseph was living in sub-human conditions with severe foot injuries. An HFH case report brought volunteers who immediately transported him to the local general hospital. After medical treatment and shelter admission, Joseph now works part-time at a community garden.',
